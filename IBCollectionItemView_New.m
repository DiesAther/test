...
-(BOOL)accpetMouseEventWithEvent:(SFEvent*)theEventSFEvent
{
    return YES;
}
...
- (void)mouseDown:(SFEvent *)theEvent
{
    //need here to prevent cycle call
}

- (void)mouseUp:(SFEvent *)theEvent
{
    //need here to prevent cycle call
}

-(void)mouseEntered:(SFEvent *)theEvent
{
    //mouse enter here
}

-(void)mouseExited:(SFEvent *)theEvent
{
    //"mouse exit here"
}

-(void)mouseMoved:(SFEvent *)theEvent
{
    //@"mouse move here"
}

-(BOOL)trackMouseEvent:(SFEvent *)theEvent
{
    return NO;
}
